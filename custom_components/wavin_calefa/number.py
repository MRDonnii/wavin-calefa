...
NUMBERS: tuple[WavinCalefaNumberDescription, ...] = (
    WavinCalefaNumberDescription(
        key="room_eco_temperature",
        source_key="room_eco_temperature",
        register=7502,
        icon="mdi:leaf",
    ...
    WavinCalefaNumberDescription(
        key="room_comfort_temperature",
        source_key="room_comfort_temperature",
        register=7503,
    ...
    WavinCalefaNumberDescription(
        key="room_extra_comfort_temperature",
        source_key="room_extra_comfort_temperature",
        register=7504,
        icon="mdi:fire",
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        native_min_value=5.0,
